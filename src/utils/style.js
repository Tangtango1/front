const style = {
  listStyle() {
    return {
      ...
      searchBtnHeight: '35px',
      tableBgColor: '#f5f5f5',
      inputIconColor: '#C0C4CC',
      searchBtnBorderRadius: '25px',
      tableStripe: true,
      btnAdAllWarnFontColor: 'rgba(24, 135, 170, 1)',
      tableBtnDelBgColor: 'rgba(87, 188, 255, 1)',
      searchBtnIcon: '1',
      tableSize: 'medium',
      searchBtnBorderStyle: 'outset ',
      text: {
        padding: '0',
      ...
      tableSelection: true,
      searchBtnBorderWidth: '3px',
      tableContentFontSize: '14px',
      searchBtnBgColor: 'var(--publicMainColor)',
      inputTitleSize: '14px',
      btnAdAllBorderColor: 'var(--publicSubColor)',
      pageJumper: false,
      ...
      tableBtnHeight: '40px',
      pagePager: true,
      searchBtnBorderColor: 'rgba(255, 255, 255, 1)',
      tableHeaderFontColor: 'rgba(255, 255, 255, 1)',
      inputTitle: '0',
      tableBtnBorderRadius: '4px',
      btnAdAllFont: '1',
      btnAdAllDelFontColor: 'rgba(24, 135, 170, 1)',
      tableBtnIcon: '1',
      btnAdAllHeight: '40px',
      btnAdAllWarnBgColor: 'rgba(255, 255, 255, 0)',
      btnAdAllBorderWidth: '0 0 5px 0',
      tableStripeFontColor: '#606266',
      tableBtnBorderStyle: 'solid',
      inputHeight: '35px',
      btnAdAllBorderRadius: '0px',
      btnAdAllDelBgColor: 'rgba(255, 255, 255, 0)',
      pagePrevNext: true,
      btnAdAllAddBgColor: 'rgba(255, 255, 255, 0)',
      searchBtnFont: '1',
      tableIndex: true,
      btnAdAllIcon: '1',
      tableSortable: false,
      ...
      tableBtnEditBgColor: 'rgba(65, 81, 169, 1)',
      box: {
        padding: '10px 20px',
        boxShadow: '0 0 6px rgba(0,0,0,0)',
        flag: '2',
        backgroundImage:
          'http://codegen.caihongy.cn/20211127/2b9991fb4d11451ab088ea8e6f78a20b.png',
        background:
          'linear-gradient(86deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 13%, rgba(24,135,171,1) 38%, rgba(24,135,171,1) 44%, rgba(255,255,255,1) 72%, rgba(255,255,255,1) 100%)',
      },
      inputBorderWidth: '3px',
      inputFontPosition: '2',
      inputFontColor: 'rgba(255, 255, 255, 1)',
      pageEachNum: 10,
      tableHeaderBgColor: 'var(--publicMainColor)',
      inputTitleColor: '#333',
      btnAdAllBoxPosition: '1',
      tableBtnDetailBgColor: 'var(--publicMainColor)',
      inputIcon: '0',
      searchBtnIconPosition: '1',
      btnAdAllFontSize: '14px',
      inputBorderStyle: 'outset ',
      tableHoverFontColor: '#333',
      inputBgColor: 'var(--publicMainColor)',
      pageStyle: true,
      pageTotal: false,
      btnAdAllAddFontColor: 'rgba(24, 135, 170, 1)',
      tableBtnFont: '1',
  ...
  addStyle() {
    return {
      ...
      btnCancelBorderRadius: '40px',
      inputBgColor: '#fff',
      inputLableFontSize: '14px',
      uploadLableColor: '#606266',
      uploadBorderRadius: '30px',
      btnSaveHeight: '44px',
      selectBgColor: '#fff',
      btnSaveWidth: '88px',
      ...
      selectBorderRadius: '30px',
      selectFontColor: '#606266',
      btnSaveBorderColor: 'rgba(65, 81, 169, 1)',

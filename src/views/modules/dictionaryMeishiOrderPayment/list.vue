    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        ...
        >
          ...
          <el-form-item>
            <el-button :icon="ElIconSearch" type="success" @click="search()"
              >查询</el-button
            >
          </el-form-item>
        </el-row>
        ...
        >
          <el-form-item>
            <el-button
              v-if="isAuth('dictionaryMeishiOrderPayment', '新增')"
              type="success"
              :icon="ElIconPlus"
            ...
            >
            <el-button
              v-if="isAuth('dictionaryMeishiOrderPayment', '删除')"
      ...
      <div class="table-content">
        <el-table
          ...
          v-if="isAuth('dictionaryMeishiOrderPayment', '查看')"
          :data="dataList"
        ...
        >
          ...
          >
            <template slot-scope="scope">
              ...
              >
              <el-button
                v-if="isAuth('dictionaryMeishiOrderPayment', '修改')"
                type="primary"
                :icon="ElIconEdit"
                size="mini"
  ...
  methods: {
    ...
    getDataList() {
      ...
      if (
        ...
        this.searchForm.indexNameSearch != undefined
      ) {
        params['indexName'] = this.searchForm.indexNameSearch
      }
      //本表的
      params['dicCode'] = 'meishi_order_payment_types' //编码名字

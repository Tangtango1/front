    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.shangjiaPhone"
              placeholder="联系方式"
              clearable
              :readonly="ro.shangjiaPhone"
            ></el-input>
          </el-form-item>
          <div v-else-if="type == 'info'">
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.shangjiaEmail"
              placeholder="邮箱"
              clearable
              :readonly="ro.shangjiaEmail"
            ></el-input>
          </el-form-item>
          <div v-else-if="type == 'info'">
        ...
        <el-col :span="12">
          <el-form-item
            class="upload"
            v-if="type != 'info' && !ro.shangjiaPhoto"
            label="营业执照展示"
            prop="shangjiaPhoto"
          >
            <file-upload
              ...
              :multiple="true"
              :fileUrls="
                ruleForm.shangjiaPhoto ? $base.url + ruleForm.shangjiaPhoto : ''
              "
          ...
          <div v-else>
            ...
            >
              <img
                ...
                v-bind:key="index"
                v-for="(item, index) in (ruleForm.shangjiaPhoto || '').split(
                  ','
                )"
                :src="$base.url + item"
                width="100"
        ...
        <el-col :span="12">
          ...
          >
            <el-select
              v-model="ruleForm.shangjiaTypes"
              :disabled="ro.shangjiaTypes"
              placeholder="请选择商家类型"
            >
              <el-option
                v-for="(item, index) in shangjiaTypesOptions"
          ...
          <div v-else-if="type == 'info'">
            <el-form-item class="input" label="商家类型" prop="shangjiaValue">
              <el-input
                v-model="ruleForm.shangjiaValue"
                placeholder="商家类型"
                readonly
              ></el-input>
            </el-form-item>
...
export default {
  data() {
    return {
      ...
      rules: {
        ...
        shangjiaPhoto: [
          { required: true, message: '营业执照展示不能为空', trigger: 'blur' },
        ],
        shangjiaTypes: [
          { required: true, message: '商家类型不能为空', trigger: 'blur' },
  ...
  created() {
    ...
    //获取下拉框信息
    this.$http({
      url: `dictionary/page?page=1&limit=100&sort=&order=&dicCode=shangjia_types`,
      method: 'get',
    }).then(({ data }) => {
      if (data && data.code === 0) {
        this.shangjiaTypesOptions = data.data.list
      }
    })
  },
  mounted() {},
  methods: {
      ...
      _this
        ...
        .then(({ data }) => {
          if (data && data.code === 0) {
            ...
            _this.ruleForm.shangjiaContent =
              _this.ruleForm.shangjiaContent.replaceAll(
                'src="upload/',
    ...
    onSubmit() {
      this.$refs['ruleForm'].validate((valid) => {
        if (valid) {
          this.ruleForm.shangjiaContent =
            this.ruleForm.shangjiaContent.replaceAll(this.$base.url, '')
          this.$http({

    ...
    >
      <el-row>
        <el-col :span="12">
          ...
          <div v-else>
            <el-form-item class="input" label="商家类型编码" prop="codeIndex">
              <el-input
                v-model="ruleForm.codeIndex"
                placeholder="商家类型编码"
                readonly
        ...
        <el-col :span="12">
          ...
          <div v-else>
            <el-form-item class="input" label="商家类型" prop="indexName">
              <el-input
                v-model="ruleForm.indexName"
                placeholder="商家类型"
                readonly
    ...
    onSubmit() {
      ...
      this.$refs['ruleForm'].validate((valid) => {
        if (valid) {
          ...
          ruleForm['dicCode'] = 'shangjia_types'
          ruleForm['dicName'] = '商家类型'
          this.$http({

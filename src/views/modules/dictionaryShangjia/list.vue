    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        ...
        >
          <el-form-item>
            <el-button
              v-if="isAuth('dictionaryShangjia', '新增')"
              type="success"
              :icon="ElIconPlus"
            ...
            >
            <el-button
              v-if="isAuth('dictionaryShangjia', '删除')"
      ...
      <div class="table-content">
        <el-table
          ...
          v-if="isAuth('dictionaryShangjia', '查看')"
          :data="dataList"
        ...
        >
          ...
          >
            <template slot-scope="scope">
              ...
              >
              <el-button
                v-if="isAuth('dictionaryShangjia', '修改')"
                type="primary"
                :icon="ElIconEdit"
                size="mini"
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      //本表的
      params['dicCode'] = 'shangjia_types' //编码名字
      ;(params['dicName'] = '商家类型'), //汉字名字
        this.$http({
          url: 'dictionary/page',
          method: 'get',
          params: params,

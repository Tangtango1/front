    ...
    >
      <el-row>
        <el-col :span="12">
          ...
          <div v-else>
            <el-form-item class="input" label="美食类型编码" prop="codeIndex">
              <el-input
                v-model="ruleForm.codeIndex"
                placeholder="美食类型编码"
                readonly
        ...
        <el-col :span="12">
          ...
          <div v-else>
            <el-form-item class="input" label="美食类型" prop="indexName">
              <el-input
                v-model="ruleForm.indexName"
                placeholder="美食类型"
                readonly
  ...
  methods: {
    ...
    onSubmit() {
      if (!this.ruleForm.indexName) {
        this.$message.error('美食类型不能为空')
        return
      }
      this.$refs['ruleForm'].validate((valid) => {
        if (valid) {
          let ruleForm = this.ruleForm
          ruleForm['dicCode'] = 'meishi_types'
          ruleForm['dicName'] = '美食类型'
          this.$http({

export declare const ElAmapMarkerCluster: import("@vuemap/vue-amap-util/dist/utils/types").SFCWithInstall<import("vue").DefineComponent<{
    points: {

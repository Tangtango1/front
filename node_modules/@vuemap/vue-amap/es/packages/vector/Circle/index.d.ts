export declare const ElAmapCircle: import("@vuemap/vue-amap-util/dist/utils/types").SFCWithInstall<import("vue").DefineComponent<Readonly<import("vue").ComponentPropsOptions<{
    [x: string]: unknown;
}>>, unknown, {
    converters: {};
}, {}, {

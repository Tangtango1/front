export declare const ElAmapControlHawkEye: import("@vuemap/vue-amap-util/dist/utils/types").SFCWithInstall<import("vue").DefineComponent<{
    autoMove: {

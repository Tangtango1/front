...
function createWrap(func, bitmask, thisArg, partials, holders, argPos, ary, arity) {
  ...
  var data = isBindKey ? undefined : _getData["default"](func);
  ...
  if (data) {
    _mergeData["default"](newData, data);
  }
  func = newData[0];
  bitmask = newData[1];
  thisArg = newData[2];
  ...
  if (!bitmask || bitmask == WRAP_BIND_FLAG) {
    var result = _createBind["default"](func, bitmask, thisArg);
  } else if (bitmask == WRAP_CURRY_FLAG || bitmask == WRAP_CURRY_RIGHT_FLAG) {
    result = _createCurry["default"](func, bitmask, arity);
  } else if ((bitmask == WRAP_PARTIAL_FLAG || bitmask == (WRAP_BIND_FLAG | WRAP_PARTIAL_FLAG)) && !holders.length) {
    result = _createPartial["default"](func, bitmask, thisArg, partials);
  } else {
    result = _createHybrid["default"].apply(undefined, newData);
  }
  var setter = data ? _baseSetData["default"] : _setData["default"];
  return _setWrapToString["default"](setter(result, newData), func, bitmask);
}

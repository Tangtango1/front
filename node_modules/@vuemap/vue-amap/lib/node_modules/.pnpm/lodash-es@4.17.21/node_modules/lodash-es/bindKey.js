 ...
 * // => 'hiya fred!'
 */
var bindKey = _baseRest["default"](function(object, key, partials) {
  var bitmask = WRAP_BIND_FLAG | WRAP_BIND_KEY_FLAG;
  if (partials.length) {
    var holders = _replaceHolders["default"](partials, _getHolder["default"](bindKey));
    bitmask |= WRAP_PARTIAL_FLAG;
  }
  return _createWrap["default"](key, bitmask, object, partials, holders);
});

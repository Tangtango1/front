...
function equalByTag(object, other, tag, bitmask, customizer, equalFunc, stack) {
  switch (tag) {
    ...
    case arrayBufferTag:
      if ((object.byteLength != other.byteLength) ||
          !equalFunc(new _Uint8Array["default"](object), new _Uint8Array["default"](other))) {
        return false;
      }
      return true;
    ...
    case setTag:
      ...
      var result = _equalArrays["default"](convert(object), convert(other), bitmask, customizer, equalFunc, stack);
      stack['delete'](object);
      return result;

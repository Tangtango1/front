...
var _escapeStringChar = require('./_escapeStringChar.js');
...
function template(string, options, guard) {
  ...
  if (guard && _isIterateeCall["default"](string, options, guard)) {
    options = undefined;
  }
  string = toString["default"](string);
  options = assignInWith["default"]({}, options, settings, _customDefaultsAssignIn["default"]);

  var imports = assignInWith["default"]({}, options.imports, settings.imports, _customDefaultsAssignIn["default"]),
      importsKeys = keys["default"](imports),
      importsValues = _baseValues["default"](imports, importsKeys);
  ...
  var reDelimiters = RegExp(
    ...
    interpolate.source + '|' +
    (interpolate === _reInterpolate["default"] ? reEsTemplate : reNoMatch).source + '|' +
  ...
  string.replace(reDelimiters, function(match, escapeValue, interpolateValue, esTemplateValue, evaluateValue, offset) {
    ...
    source += string.slice(index, offset).replace(reUnescapedString, _escapeStringChar["default"]);

...
var _arrayIncludesWith = require('./_arrayIncludesWith.js');
...
function baseIntersection(arrays, iteratee, comparator) {
  ...
  while (othIndex--) {
    ...
    if (othIndex && iteratee) {
      array = _arrayMap["default"](array, _baseUnary["default"](iteratee));
    }
    maxLength = nativeMin(array.length, maxLength);
    caches[othIndex] = !comparator && (iteratee || (length >= 120 && array.length >= 120))
      ? new _SetCache["default"](othIndex && array)
      : undefined;
  }
  array = arrays[0];
  ...
  while (++index < length && result.length < maxLength) {
    ...
    if (!(seen
          ? _cacheHas["default"](seen, computed)
      ...
      while (--othIndex) {
        ...
        if (!(cache
              ? _cacheHas["default"](cache, computed)
...
//# sourceMappingURL=_baseIntersection.js.map

export declare const ElAmapEllipse: import("@vuemap/vue-amap-util/dist/utils/types").SFCWithInstall<import("vue").DefineComponent<Readonly<import("vue").ComponentPropsOptions<{
    [x: string]: unknown;
}>>, unknown, {
    converters: {};
}, {}, {
    ...
    editable: boolean;
}>, import("vue").ComponentOptionsMixin, ("update:center" | "update:radius")[], "update:center" | "update:radius", import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, Readonly<readonly string[] | import("vue").ExtractPropTypes<Readonly<import("vue").ComponentObjectPropsOptions<{
    [x: string]: unknown;
}>>>> & {

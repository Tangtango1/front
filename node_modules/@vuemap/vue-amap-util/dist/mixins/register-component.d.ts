...
declare const _default: import("vue").DefineComponent<{
    ...
    needInitComponents: ({
        ...
        $watch(source: string | Function, cb: Function, options?: import("vue").WatchOptions<boolean> | undefined): WatchStopHandle;
    ...
    initProps(): void;
    lazyRegister(): void;
    addChildComponent(component: ComponentPublicInstance & customComponent): void;
    createChildren(): void;
    register(): void;
